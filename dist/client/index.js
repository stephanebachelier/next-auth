...
var _parseUrl3 = _interopRequireDefault(require("../lib/parse-url"));

var _baseUrl2 = _interopRequireDefault(require("../lib/base-url"));
...
var _parseUrl = (0, _parseUrl3.default)((0, _baseUrl2.default)({
  serverSide: false
})),
    baseUrl = _parseUrl.baseUrl,
    basePath = _parseUrl.basePath;

var _parseUrl2 = (0, _parseUrl3.default)((0, _baseUrl2.default)({
  serverSide: true
})),
    baseUrlServer = _parseUrl2.baseUrl,
    basePathServer = _parseUrl2.basePath;

var __NEXTAUTH = {
  baseUrl: baseUrl,
  basePath: basePath,
  baseUrlServer: baseUrlServer,
  basePathServer: basePathServer,
  keepAlive: 0,
  clientMaxAge: 0,
  _clientLastSync: 0,
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 4:
            ...
            _context9.next = 8;
            return fetch("".concat(_baseUrl, "/").concat(path), options);
